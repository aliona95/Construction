...
public class BallVolumeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ball_volume);
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case R.id.button:
                        ...
                        area = (float) (firstEdge * firstEdge * firstEdge * 3.1415 * 4 / 3);
